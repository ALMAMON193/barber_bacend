        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item {{ request()->routeIs('admin.staff.register.*') ? 'active' : '' }}">
                    ...
                    <div class="collapse menu-dropdown {{ request()->routeIs('admin.staff.register.*') ? 'show' : '' }}" id="sidebarMaps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item {{ request()->routeIs('admin.staff.register.create') ? 'active' : '' }}">
                                <a href="{{route('admin.staff.register.create')}}" class="nav-link" data-key="t-google">
                                    New Register
                                </a>
                            </li>
                            <li class="nav-item {{ request()->routeIs('admin.staff.register.index') ? 'active' : '' }}">
                                <a href="{{route('admin.staff.register.index')}}" class="nav-link" data-key="t-vector">
                                    All Staffs
                                </a>
                            </li>
                        </ul>
