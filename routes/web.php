...
use App\Http\Controllers\Web\Backend\Admin\ServiceController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/service/{id}/view', action: [ServiceController::class, 'view'])->name('admin.service.view');
    ...
    Route::delete('admin/service/delete/{id}', [ServiceController::class, 'destroy'])->name('admin.service.destroy');
});
